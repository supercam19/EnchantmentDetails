...
$execute if items entity @s container.$(itter) enchanted_book[minecraft:stored_enchantments~[{enchantments:"minecraft:$(name)"}]] run function enchdetails:modify with storage ench details
